...
<html lang="en">
  <head>
    ...
    <title>เเก้ไขข้อมูลหมอเวร</title>
  ...
  <body class="text-center">
    <main class="form-signin">
      <form action="add_ot.php?status=upd" onkeydown="return event.key != 'Enter';" method="POST" enctype="multipart/form-data" name="add" class="form-horizontal" id="add">
        ...
        <h4 class="h3 mb-3 fw-normal">เเก้ไขการเงินหมอเวร</h4>
        <br>
        <br>
        ...
        <div class="row g-1">
          <div class="col-6">    
            <div class="form-floating">
              <input list="OptionsTime1" class="form-control" name="time1" value="<?php echo $row['TIME1'];?>" class="form-control" id="floatingTime1" placeholder="TIME1">
          ...
          <div class="col-6">  
            <div class="form-floating">
              <input list="OptionsTime2" class="form-control" name="time2" value="<?php echo $row['TIME2'];?>" class="form-control" id="floatingTime2" placeholder="TIME2">
        ...
        <div class="form-floating">
          <input list="OptionsDoctorfee" name="doctorfee" value="<?php echo $row['DOCTORFEE'];?>" class="form-control" id="floatingDoctorfee" placeholder="DOCTORFEE">
        ...
        <div class="form-floating">
          <input list="OptionsPt_name" name="pt_name" value="<?php echo $row['PT_NAME'];?>" class="form-control" id="floatingPt_name" placeholder="PT_NAME">
        ...
        <input type="button" class="btn btn-danger" name="Cancel" id="Cancel" value="Cancel" onclick="window.location='show_ot.php' ">
      </form>
    </main>
  </body>
</html>
